...
# 预训练好的网络模型，来自NVIDIA
Model = 'D:/QQ文件/毕设/stylegan2/models/stylegan2-ffhq-config-f.pkl'
_Gs_cache = dict()
...
def move_and_show(generator, flag, latent_vector, direction, coeffs):
    fig,ax = plt.subplots(1, len(coeffs), figsize=(30, 20), dpi=80)
...
def main():
    ...
    person = np.load(os.path.join(config.dlatents_dir, 'seed6602.npy'))
